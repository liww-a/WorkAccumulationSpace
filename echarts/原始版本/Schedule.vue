                ...
                <card>
                    ...
                    <div class="half-height">
                        <chart-card>
                            ...
                            <milestone-chart :data="milestoneData" :option="milestoneOption" :min-range="milestoneRange.min" :max-range="milestoneRange.max"></milestone-chart>
                        </chart-card>
                    </div>
                    <div class="half-height">
                        <chart-card>
